        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-brand-secondary hover:border-brand-secondary transition-colors shadow-sm">
          ...
          <div className="lg:col-span-1">
            <h4 className="text-slate-900 font-bold mb-6">Products</h4>
            <ul className="space-y-4">
          ...
          <div className="lg:col-span-2">
            <h4 className="text-slate-900 font-bold mb-6">Compliance & Legal</h4>
            <ul className="space-y-4">
