...
export function FinalCTA() {
  return (
    <section id="final-cta" className="relative min-h-[80vh] flex items-center justify-center py-16 md:py-32 overflow-hidden bg-brand-primary">
      {/* 3D Background */}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 relative z-10">
            <MagneticButton className="w-full sm:w-auto">
              <button
                ...
                className="bg-white hover:bg-slate-100 text-brand-primary px-6 py-3 md:px-8 md:py-4 rounded-full text-base md:text-lg font-bold shadow-[0_10px_30px_rgba(255,255,255,0.2)] transition-all flex items-center justify-center w-full whitespace-nowrap cursor-pointer"
              >
            ...
            <MagneticButton className="w-full sm:w-auto">
              <button
                onClick={() => window.dispatchEvent(new CustomEvent("open-early-access-modal"))}
                className="bg-transparent hover:bg-white/10 border border-white/30 text-white px-6 py-3 md:px-8 md:py-4 rounded-full text-base md:text-lg font-medium transition-all flex items-center justify-center w-full gap-2 whitespace-nowrap cursor-pointer"
              >
                <PhoneCall size={18} /> Book A Demo / Contact Admin
              </button>
            </MagneticButton>
          </div>
        </motion.div>
