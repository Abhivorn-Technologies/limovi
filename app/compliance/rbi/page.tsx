        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-8 md:p-10">
            <p className="text-lg text-slate-600 font-medium leading-relaxed">
              This section is currently being finalized by our legal and compliance teams. The complete regulatory documentation and disclosures will be published here prior to the official launch of the platform.
            </p>
            <p className="text-lg text-slate-600 font-medium leading-relaxed mt-4">
              If you have any immediate questions regarding our compliance framework, please reach out to our support team.
            </p>
          </div>
        </div>
      </section>
